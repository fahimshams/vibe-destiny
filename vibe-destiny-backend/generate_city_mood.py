...
def generate_mood_itinerary(mood):
    prompt = """
    ...
    itinerary_start = generated_text.find("Itinerary:")
    other_content = generated_text[:itinerary_start].strip()

    # Extract the Itinerary section
    itinerary_text = generated_text[itinerary_start + len("Itinerary:"):].strip()
